...
但所幸，[Babel](/babel/%E7%AC%AC1%E7%AB%A0_%E5%89%8D%E8%A8%80) 横空出世，它就是一个作用：转换，将你写的 JS 转换成大多数浏览器都支持的语法样式。

这样，你就能够在使用 JS 最新的特性的同时，而又不用担心浏览器的兼容性问题了。

确实很棒的东西，甚至你可以说它挽救了 JS！

再此之后很多转换器也纷纷亮相。比如97年韩国小哥[swc](https://swc.rs)、Figma的CTO发明的[esbuild](https://esbuild.github.io)