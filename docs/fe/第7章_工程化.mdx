...
## 脚手架
在学习框架的时候，其实已经用到了脚手架。        
脚手架就是指通过选择几个选项快速搭建项目基础代码的工具。   
脚手架创建的项目 会帮助你自动继承了很多工程化所需的内容。

虽然方便了，但是这并不利于学习底层知识，如果想学习工程化，就不能完全依赖它！
...
![fe-7.1](/img/fe/7.1.png)

</TabItem>
<TabItem value="babel处理" label="babel处理" >

![fe-7.2](/img/fe/7.2.jpg)
