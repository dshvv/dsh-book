...
幸运的是，faceBook 官方已经注意到了这个情况，于是自己在很早之前着手并且现在已经发行了官方的 redux 辅助工具包，叫做[react-toolkit](https://redux-toolkit.js.org)，里边提供了很多使用的东西，其中就就包括以上两个生成器。
